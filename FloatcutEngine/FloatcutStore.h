...
@protocol FloatcutStoreDelegate <NSObject>
@optional
...
@protocol FloatcutStoreDeleteDelegate <NSObject>
@optional
- (void)willDeleteClippingFromStore:(id)store AtIndex:(int)index;
@end

@interface FloatcutStore : NSObject {
...
@property (nonatomic, nullable, assign) id<FloatcutStoreDelegate> delegate;

/** optional delegate (not retained) */
@property (nonatomic, nullable, assign) id<FloatcutStoreDeleteDelegate> deleteDelegate;
